...
const translations = {
  en: {
    ...
    targetPlatformHint: 'What platform will your app target?',
    webApp: 'Web',
    iosApp: 'iOS',
    androidApp: 'Android',
    bothMobile: 'Both (iOS & Android)',
    ...
    aiAgents: 'AI Agents',
    backendPrompts: 'Backend Prompts',
    backendPromptsLaravel: 'Backend Prompts (Laravel)',
    frontendPrompts: 'Frontend Prompts',
    frontendPromptsVue: 'Frontend Prompts (Vue.js)',
    frontendPromptsSwift: 'Frontend Prompts (Swift)',
    frontendPromptsKotlin: 'Frontend Prompts (Kotlin)',
    frontendPromptsCrossPlatform: 'Frontend Prompts (Flutter/React Native)',
  ...
  ar: {
    ...
    targetPlatformLabel: 'منصة المستهدفة',
    targetPlatformHint: 'ما هي المنصة التي يستهدفها تطبيقك؟',
    webApp: 'الويب',
    iosApp: 'iOS',
    androidApp: 'أندرويد',
    bothMobile: 'الجميع (iOS & أندرويد)',
  ...
  fr: {
    ...
    targetPlatformLabel: 'Plateforme cible',
    targetPlatformHint: 'Quelle plateforme votre application ciblera-t-elle ?',
    webApp: 'Web',
    iosApp: 'iOS',
    androidApp: 'Android',
    bothMobile: 'Les deux (iOS & Android)',
    ...
    aiAgents: 'Agents IA',
    backendPrompts: 'Prompts Backend',
    backendPromptsLaravel: 'Prompts Backend (Laravel)',
    frontendPrompts: 'Prompts Frontend',
    frontendPromptsVue: 'Prompts Frontend (Vue.js)',
    frontendPromptsSwift: 'Prompts Frontend (Swift)',
    frontendPromptsKotlin: 'Prompts Frontend (Kotlin)',
    frontendPromptsCrossPlatform: 'Prompts Frontend (Flutter/React Native)',
  ...
  sw: {
    ...
    targetPlatformLabel: 'Jukwaa la Lengo',
    targetPlatformHint: 'Programu yako inahitaji kufanya kazi kwenye jukwaa gani?',
    webApp: 'Web',
    iosApp: 'iOS',
    androidApp: 'Android',
    bothMobile: 'Zote (iOS & Android)',
  ...
  ha: {
    ...
    targetPlatformLabel: 'Ayyukan Jiragen Ruwa',
    targetPlatformHint: 'Ayyukarka zai aiki a wane jiragen ruwa?',
    webApp: 'Web',
    iosApp: 'iOS',
    androidApp: 'Android',
    bothMobile: 'Duka (iOS & Android)',
  ...
  yo: {
    ...
    targetPlatformLabel: 'Àkó̩sílẹ̀ Àkọ́jọ̀',
    targetPlatformHint: 'Àwọn àkó̩sílẹ̀ kí ló n fún àmò̩lùwípò?',
    webApp: 'Web',
    iosApp: 'iOS',
    androidApp: 'Android',
    bothMobile: 'Púùpọ̀ (iOS & Android)',
  ...
  am: {
    ...
    targetPlatformLabel: 'የማግኘት ፕላትፎርም',
    targetPlatformHint: 'አፕሊኬሽንዎ ለምንድን ፕላትፎርም ነው ይገኛል?',
    webApp: 'ዶብ',
    iosApp: 'iOS',
    androidApp: 'አንድሮድ',
    bothMobile: 'ሁሉንንም (iOS & አንድሮድ)',
  ...
  or: {
    ...
    targetPlatformLabel: 'Barnootaa Aplikeshinii',
    targetPlatformHint: 'Aplikeshinichaa barnootaa keessaa qabxii qophaa?',
    webApp: 'Web',
    iosApp: 'iOS',
    androidApp: 'Android',
    bothMobile: 'Hundaa (iOS & Android)',
  ...
  ig: {
    ...
    targetPlatformLabel: 'ỌrụPlatform',
    targetPlatformHint: 'Kedu platform aṅwạn úzọ̀ gị ga emepụta?',
    webApp: 'Web',
    iosApp: 'iOS',
    androidApp: 'Android',
    bothMobile: 'Nile (iOS & Android)',
  ...
  lg: {
    ...
    targetPlatformLabel: 'Eplatform y Okuzimbibwa',
    targetPlatformHint: 'Olwino lwo lulwanga lwa kugenderera eplatform enna?',
    webApp: 'Web',
    iosApp: 'iOS',
    androidApp: 'Android',
    bothMobile: 'Ebyona (iOS & Android)',
