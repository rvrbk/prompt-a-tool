...
const translations = {
  en: {
    ...
    aboutBackendPrompts: 'Backend Prompts',
    aboutBackendPromptsDesc: 'Guidance for building the server and database for your app',
    aboutFrontendPrompts: 'Frontend Prompts',
    aboutFrontendPromptsDesc: 'Guidance for building the user interface of your app',
  ...
  ar: {
    ...
    aboutBackendPrompts: 'مطالبات Backend',
    aboutBackendPromptsDesc: 'إرشادات لبناء الخادم وقاعدة البيانات لتطبيقك',
    aboutFrontendPrompts: 'مطالبات Frontend',
    aboutFrontendPromptsDesc: 'إرشادات لبناء واجهة المستخدم لتطبيقك',
  ...
  fr: {
    ...
    aboutBackendPrompts: 'Prompts Backend',
    aboutBackendPromptsDesc: 'Des conseils pour construire le serveur et la base de données de votre application',
    aboutFrontendPrompts: 'Prompts Frontend',
    aboutFrontendPromptsDesc: 'Des conseils pour construire l\'interface utilisateur de votre application',
  ...
  sw: {
    ...
    aboutBackendPrompts: 'Maombi ya Backend',
    aboutBackendPromptsDesc: 'Mwongozo wa kujenga server na database ya programu yako',
    aboutFrontendPrompts: 'Maombi ya Frontend',
    aboutFrontendPromptsDesc: 'Mwongozo wa kujenga interfeisi ya mtumiaji wa programu yako',
  ...
  ha: {
    ...
    aboutBackendPrompts: 'Ayyukan Backend',
    aboutBackendPromptsDesc: 'Nasarin yin server da database don ayyukarka',
    aboutFrontendPrompts: 'Ayyukan Frontend',
    aboutFrontendPromptsDesc: 'Nasarin yin interface na masu amfani don ayyukarka',
  ...
  yo: {
    ...
    aboutBackendPrompts: 'Àmò̩lùwípò Backend',
    aboutBackendPromptsDesc: 'Àwọn ìtọ́jú àwọn àlà àwújọ̀ àwọn àkó̩sílẹ̀ Backend',
    aboutFrontendPrompts: 'Àmò̩lùwípò Frontend',
    aboutFrontendPromptsDesc: 'Àwọn ìtọ́jú àwọn àlà àwújọ̀ àwọn àkó̩sílẹ̀ Frontend',
  ...
  am: {
    ...
    aboutBackendPrompts: 'የሳይት ባህሪ ጥናቶች',
    aboutBackendPromptsDesc: 'ለአፕሊኬሽንዎ ሳይት እና ዳታቤዝ ለማገናገን ምርማሮች',
    aboutFrontendPrompts: 'የተጠቃሚ ባህሪ ጥናቶች',
    aboutFrontendPromptsDesc: 'ለአፕሊኬሽንዎ ተጠቃሚ አቀራርጥ ለማገናገን ምርማሮች',
  ...
  or: {
    ...
    aboutBackendPrompts: 'Qophaawwan Backend',
    aboutBackendPromptsDesc: 'Serverii fi Database Aplikeshiniin keessaa ifaa.',
    aboutFrontendPrompts: 'Qophaawwan Frontend',
    aboutFrontendPromptsDesc: 'Aplikeshinii Seensii ifaa.',
  ...
  ig: {
    ...
    aboutAIAgentsDesc: 'AI Ákwúkwọ̀ na Àkwúkwọ̀ gị na Àkwúkwọ̀',
    aboutBackendPrompts: 'Àkwúkwọ̀ Backend',
    aboutBackendPromptsDesc: 'Àkwúkwọ̀ Backend na Àkwúkwọ̀ gị',
    aboutFrontendPrompts: 'Àkwúkwọ̀ Frontend',
    aboutFrontendPromptsDesc: 'Àkwúkwọ̀ Frontend na Àkwúkwọ̀ gị',
  ...
  lg: {
    ...
    aboutBackendPrompts: 'Ebifanana ebya System',
    aboutBackendPromptsDesc: 'Ebyokulabirira okuyambibwa server ne database ya olwino lwo',
    aboutFrontendPrompts: 'Ebifanana ebya Olwino',
    aboutFrontendPromptsDesc: 'Ebyokulabirira okuyambibwa ekitundibwa kya omukwano',
